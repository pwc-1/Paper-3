...
def parse_config():
    ...
    parser.add_argument('--ckpt', type=str, default='tools/OKGR_KITTI_best.pth', help='checkpoint to start from')
...
def main():
    ...
    model = PVRCNNPlusPlus(model_cfg=cfg.MODEL, num_class=len(cfg.CLASS_NAMES), dataset=test_set)
    if args.eval_all:
