...
class MultiheadAttention(mindspore.nn.MultiheadAttention):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0.0, bias=True,
        ...
        super().__init__( embed_dim=embed_dim, num_heads=num_heads, dtype=mindspore.float16)
...
class Transformer(mindspore.nn.Transformer):
    def __init__(self, d_model, nhead, num_encoder_layers, num_decoder_layers, dim_feedforward, dropout, activation,
        ...
        super().__init__(d_model=d_model, dim_feedforward=dim_feedforward,
                         num_encoder_layers=num_encoder_layers, num_decoder_layers=num_decoder_layers, nhead=nhead,
    ...
    def construct(self, src, tgt, src_mask=None, tgt_mask=None, memory_mask=None, src_key_padding_mask=None,
        ...
        output = super().construct(src,tgt, src_mask,  tgt_mask)
        return output
