...
at::Tensor boxes_overlap_bev_gpu(at::Tensor boxes_a, at::Tensor boxes_b, at::Tensor ans_overlap){
...
std::vector<at::Tensor> nms_gpu(at::Tensor boxes, at::Tensor keep, float nms_overlap_thresh){
...
//    printf("boxes_num=%d, col_blocks=%d\n", boxes_num, col_blocks);
    ...
    torch::Tensor num_to_keep1 = torch::tensor(num_to_keep);
    return {num_to_keep1,keep};
}
