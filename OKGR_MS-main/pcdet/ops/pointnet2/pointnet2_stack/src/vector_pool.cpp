...
std::vector<torch::Tensor> query_stacked_local_neighbor_idxs_wrapper_stack(at::Tensor support_xyz_tensor, at::Tensor xyz_batch_cnt_tensor,
    ...
    return {cumsum_tensor,stack_neighbor_idxs_tensor,start_len_tensor};
}


std::vector<torch::Tensor> query_three_nn_by_stacked_local_idxs_wrapper_stack(at::Tensor support_xyz_tensor,
    ...
    return {new_xyz_grid_dist2_tensor,new_xyz_grid_idxs_tensor};
}


std::vector<torch::Tensor> vector_pool_wrapper_stack(at::Tensor support_xyz_tensor, at::Tensor xyz_batch_cnt_tensor,
    ...
    torch::Tensor cum_sum1=torch::tensor(cum_sum);
    return {cum_sum1,grouped_idxs_tensor,point_cnt_of_grid_tensor,new_features_tensor,new_local_xyz_tensor};
}
