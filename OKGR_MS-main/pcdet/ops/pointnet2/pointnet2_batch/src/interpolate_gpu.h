...
std::vector<at::Tensor> three_nn_wrapper_fast(int b, int n, int m, at::Tensor unknown_tensor, 
...
at::Tensor three_interpolate_wrapper_fast(int b, int c, int m, int n, at::Tensor points_tensor, 
